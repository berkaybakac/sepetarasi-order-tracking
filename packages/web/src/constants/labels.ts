...
export const UI_LABELS = {
	...
	DISPLAY_SETTINGS: {
		...
		OPEN_DISPLAY: "Web Önizleme",
		OPEN_TB1_256_DISPLAY: "LED 256x512",
		OPEN_TB1_344_DISPLAY: "LED 344x344",
		OPEN_TB1_512_DISPLAY: "LED 512x512",
		ADVANCED_TITLE: "Gelişmiş Önizleme Ayarları",
		ADVANCED_HINT: "Sadece web önizleme ekranı için kullanılır.",
